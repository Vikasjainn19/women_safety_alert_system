...
def women_rights(request): return render(request, 'main_app/women_rights.html')


def women_laws(request):
    return render(request, 'main_app/women_laws.html')

def developers(request): return render(request, 'main_app/developers.html')
def about_us(request): return render(request, 'main_app/about_us.html')
